    ...
    describe('http error mapping', function () {
        test('when 500 occurs', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        IOA = setupCreateIndexResponse({ status: 500, text: function () { return 'backend error message'; } }, undefined, false);
                        toThrow = function () { return __awaiter(void 0, void 0, void 0, function () {
                            var createIndexFn;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        createIndexFn = (0, createIndex_1.createIndex)(IOA);
                                        return [4 /*yield*/, createIndexFn({ name: 'index-name', dimension: 10 })];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
        ...
        test('when 400 occurs, displays server message', function () { return __awaiter(void 0, void 0, void 0, function () {
            var serverError, IOA, toThrow;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        serverError = 'there has been a server error!';
                        IOA = setupCreateIndexResponse({ status: 400, text: function () { return serverError; } }, undefined, false);
                        toThrow = function () { return __awaiter(void 0, void 0, void 0, function () {
                            var createIndexFn;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
        ...
        test('when 409 occurs', function () { return __awaiter(void 0, void 0, void 0, function () {
            var IOA, toThrow;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        IOA = setupCreateIndexResponse({ status: 409, text: function () { return 'conflict error message'; } }, undefined, false);
                        toThrow = function () { return __awaiter(void 0, void 0, void 0, function () {
                            var createIndexFn;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                        ...
                        return [4 /*yield*/, expect(toThrow).rejects.toThrow(errors_1.PineconeConflictError)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
